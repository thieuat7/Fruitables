                            ...
                            <form method="post" action="/admin/product/update/{{$product->id}}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control @error('product_detailDesc') is-invalid @enderror"
                                        ...
                                        placeholder="Enter detailed description">{{ old('product_detailDesc', $product->product_detailDesc) }}</textarea>
